...
Parent: [Distributed Inference](../README.md)

Open-source package support files for the Pkg Test Node module.

## Key Files

- `distributed_inference_bg.wasm.d.ts`: Source file in this module.
- `distributed_inference.d.ts`: Source file in this module.
- `distributed_inference.js`: Script or runtime helper.
- `package.json`: Source file in this module.
