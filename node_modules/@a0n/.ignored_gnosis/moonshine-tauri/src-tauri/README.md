...
Parent: [Moonshine Tauri](../README.md)

Open-source package support files for the Src Tauri module.

## Key Files

- `build.rs`: Source file in this module.
- `Cargo.toml`: Source file in this module.
- `tauri.conf.json`: Source file in this module.
