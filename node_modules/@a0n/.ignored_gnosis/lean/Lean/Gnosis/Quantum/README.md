...
Open-source package support files for the Quantum module.

## Key Files

- `QuantumCancerTriples.lean`: Source file in this module.
- `QuantumObserver.lean`: Source file in this module.
