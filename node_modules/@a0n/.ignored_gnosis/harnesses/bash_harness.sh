#!/bin/sh
# Gnosis polyglot execution harness for Bash/Shell scripts.
#
# Simply executes the target script and captures output.
...
RUN_STDOUT=$(bash "$FILE_PATH" 2>"$TMPDIR/gnode_stderr_$$") || EXIT_CODE=$?
