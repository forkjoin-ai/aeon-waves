#!/bin/sh
# Gnosis polyglot execution harness for Swift.
#
# Uses swift to interpret or swiftc to compile the target file.
...
# Swift can interpret .swift files directly.
RUN_STDOUT=$(swift "$FILE_PATH" 2>"$TMPDIR/gnode_stderr_$$") || EXIT_CODE=$?
