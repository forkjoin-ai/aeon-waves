...
pub fn all_recognizers() -> Vec<Box<dyn FrameworkRecognizer>> {
    vec![
        Box::new(super::framework_recognizers::chi::ChiRecognizer),
        Box::new(super::framework_recognizers::echo::EchoRecognizer),
        Box::new(super::framework_recognizers::express::ExpressRecognizer),
        Box::new(super::framework_recognizers::fastapi::FastAPIRecognizer),
        Box::new(super::framework_recognizers::fastify::FastifyRecognizer),
        Box::new(super::framework_recognizers::flask::FlaskRecognizer),
        Box::new(super::framework_recognizers::fiber::FiberRecognizer),
        Box::new(super::framework_recognizers::gin::GinRecognizer),
        Box::new(super::framework_recognizers::hono::HonoRecognizer),
        Box::new(super::framework_recognizers::koa::KoaRecognizer),
        Box::new(super::framework_recognizers::mql5::Mql5Recognizer),
