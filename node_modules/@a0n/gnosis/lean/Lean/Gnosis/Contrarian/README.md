...
Open-source package support files for the Contrarian module.

## Key Files

- `ContrarianLatentWitnessAbsence.lean`: Source file in this module.
- `ContrarianMemoryThrashingEfficiency.lean`: Source file in this module.
