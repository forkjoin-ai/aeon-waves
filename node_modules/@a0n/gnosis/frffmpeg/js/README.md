...
Parent: [Frffmpeg](../README.md)

Open-source package support files for the Js module.

## Key Files

- `frffmpeg-wasm.test.mjs`: Script or runtime helper.
- `frffmpeg-wasm.ts`: Source file in this module.
