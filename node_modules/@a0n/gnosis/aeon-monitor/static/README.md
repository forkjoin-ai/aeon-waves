...
Parent: [Aeon Monitor](../README.md)

Open-source package support files for the Static module.

## Key Files

- `knot-viz.html`: Source file in this module.
- `mesh-telemetry.html`: Source file in this module.
