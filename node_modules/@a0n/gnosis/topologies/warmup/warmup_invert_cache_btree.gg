...
(result)-[:TUNNEL { condition: 'bounded-reject' }]->(warmup_invert_cache_btree_gg_trace:Trace)
(result)-[:MEASURE { reason: 'topology-audit' }]->(warmup_invert_cache_btree_gg_trace:Trace)
