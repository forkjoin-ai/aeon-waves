// warmup_invert_cache_tlb.gg — Inverted Cache / Index Reuse: TLB (Translation Lookaside Buffer)
//
...
(fast_path: State { name: 'tlb' })
(slow_path: State { name: 'page_table_walk' })
...
(result)-[:TUNNEL { condition: 'bounded-reject' }]->(warmup_invert_cache_tlb_gg_trace:Trace)
(result)-[:MEASURE { reason: 'topology-audit' }]->(warmup_invert_cache_tlb_gg_trace:Trace)
