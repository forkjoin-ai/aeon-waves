// warmup_invert_cache_arp.gg — Inverted Cache / Index Reuse: ARP caching
//
...
(fast_path: State { name: 'arp_cache' })
(slow_path: State { name: 'arp_broadcast' })
...
(result)-[:TUNNEL { condition: 'bounded-reject' }]->(warmup_invert_cache_arp_gg_trace:Trace)
(result)-[:MEASURE { reason: 'topology-audit' }]->(warmup_invert_cache_arp_gg_trace:Trace)
