// warmup_invert_cache_dns.gg — Inverted Cache / Index Reuse: DNS caching
//
...
(fast_path: State { name: 'local_dns_cache' })
(slow_path: State { name: 'root_dns_servers' })
...
(result)-[:TUNNEL { condition: 'bounded-reject' }]->(warmup_invert_cache_dns_gg_trace:Trace)
(result)-[:MEASURE { reason: 'topology-audit' }]->(warmup_invert_cache_dns_gg_trace:Trace)
