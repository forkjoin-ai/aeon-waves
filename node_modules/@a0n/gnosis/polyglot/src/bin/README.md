...
Source module for the Bin feature area.

## Key Files

- `dump_java.rs`: Source file in this module.
- `gnexec.rs`: Source file in this module.
- `monster.rs`: Source file in this module.
- `webgpu_host.rs`: Source file in this module.
